        ...
        {isFavoritesEmpty ? (
          <div className="text-center py-16 animate-fade-in">
            ...
            <p className="text-gray-600 mb-6">
              Start exploring and save destinations, hotels, or activities you love
            </p>
            <Link
              href="/destinations"
              className="inline-flex items-center justify-center px-6 py-3 bg-wanderwise-primary text-white font-medium rounded-lg hover:bg-blue-600 transition-colors"
            >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {favoriteDestinations.map(destination => (
                      ...
                      >
                        ...
                        <button
                          onClick={() => removeItem("destination", destination.id)}
