...
//             <button href = '/' className="px-6 py-3 bg-blue-600 rounded-lg hover:bg-blue-700 transition duration-300 mt-5">
//             <Link href = '/explore' className="">Explore Now</Link>
//             </button>
//         </div>
        ...
        >
          ...
          <form onSubmit={handleSearch} className="search-bar mb-12">
            <div className="relative flex">
              ...
              <button
                type="submit"
                className="absolute right-1 top-1 bg-wanderwise-secondary text-white p-3 rounded-full hover:bg-orange-500 transition-colors"
                aria-label="Search"
              >
